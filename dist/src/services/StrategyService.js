...
export class StrategyService {
     ...
     */
    static async getOportunidades(ticker, lot, manualPrice) {
     ...
     */
    static formatForFrontend(s, lot) {
        const feesTotal = s.pernas.length * this.FEE_PER_LEG;
        const checkIlimitado = (val) => val === 'Ilimitado' || (typeof val === 'number' && val > 900000);
...
StrategyService.FEE_PER_LEG = 22.00;
