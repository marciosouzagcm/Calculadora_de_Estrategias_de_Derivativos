...
export class CalendarSpread {
    constructor() {
        this.name = 'Calendar Spread (Trava de Linha)';
    ...
    calculateMetrics(allOptions, assetPrice, feePerLeg) {
        ...
        const validOptions = allOptions.filter(o => o.tipo !== 'SUBJACENTE' &&
            o.strike && o.strike > 0 &&
            o.premio && o.premio > 0);
        for (let i = 0; i < validOptions.length; i++) {
            for (let j = 0; j < validOptions.length; j++) {
                ...
                if (strikeDiff > (legShort.strike * 0.006))
                    continue;
